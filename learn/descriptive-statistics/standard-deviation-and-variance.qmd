...
It's impossible to interpret the variance in itself. This is due to the fact that we squared the values, which changes the original unit of them (e.g it does not make much to interpret squared centimeters).

The main thing we can say about variance is that the higher it is, the more our values tend to be spreaded.
